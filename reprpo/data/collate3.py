...
#         batch['prompt'], batch['chosen'] = apply_chat_template_to_completion(self.tokenizer, batch["prompt"], batch["chosen_ids"])
#         batch['rejected'] = apply_chat_template_to_completion(self.tokenizer, batch["prompt"], batch["rejected_ids"])[1]
