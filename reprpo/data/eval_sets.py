...
TRAINING_EXPERIMENTS = {
    ...
    "code": [
        {"target": "code", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
    ...
    "alpaca_mmlu": [
        {"target": "alpaca_mmlu", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
    ...
    "alpaca_low_quality": [
        {"target": "alpaca_low_quality", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
    ...
    "shp_low_quality": [
        {"target": "shp_low_quality", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
    ...
    "cooking": [
        {"target": "cooking", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
    ...
    "code_easy": [
        {"target": "code_easy", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
    ...
    "us_history": [
        {"target": "us_history", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
    ...
    "raven_matrices": [
        {"target": "raven_matrices", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
        {"target": "us_history", "type": "cross_domain", "label": "skill", "category": "extreme"},
        {"target": "code", "type": "cross_domain", "label": "skill", "category": "extreme"},
        {"target": "wassname/ethics_expression_preferences:justice", "type": "moral_transfer", "label": "moral_alignment", "category": "alignment"},
        {"target": "wassname/medical-dpo-V2#data", "type": "orthogonal", "label": "orthogonal", "category": "orthogonal"},
    ...
    "change_my_view": [
        {"target": "change_my_view", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
        {"target": "raven_matrices", "type": "cross_domain", "label": "skill", "category": "extreme"},
        {"target": "cooking", "type": "cross_domain", "label": "skill", "category": "extreme"},
        {"target": "wassname/ethics_expression_preferences:justice", "type": "moral_transfer", "label": "moral_alignment", "category": "alignment"},
        {"target": "wassname/medical-dpo-V2#data", "type": "orthogonal", "label": "orthogonal", "category": "orthogonal"},
    ...
    "alpaca_easy": [
        {"target": "alpaca_easy", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
    ...
    "arc_easy": [
        {"target": "arc_easy", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
    ...
    "us_history_textbook": [
        {"target": "us_history_textbook", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
    ...
    "alpaca_chat": [
        {"target": "alpaca_chat", "type": "in_domain", "label": "baseline", "category": "orthogonal"},
...
TABLE_COLUMNS = {
    ...
    "orthogonal": "Orthogonal"          # negative orthogonal
}
