...
This gives you a nice structure like:
    python cli.py train dpo --model.base_model=Qwen/Qwen3-0.6B --data.dataset=math
    python cli.py train innerpo --method.transform=supr --model.lora_r=32
    python cli.py eval ./outputs/model --eval.datasets=[math,code]
"""
...
class ModelConfig:
    ...
    lora_r: int = 16
    lora_alpha: int = 32
    layers: List[int] = None  # Will default to [8, 12, 16]
...
class ConfigCommand:
    ...
    def run(self):
        ...
        print("   python cli.py train dpo")
        
        print("\n2. InnerPO with SUPR transform:")
        print("   python cli.py train innerpo --method.transform=supr")
        
        print("\n3. Custom model and data:")
        print("   python cli.py train innerpo \\")
        ...
        print("\n4. Evaluation:")
        print("   python cli.py eval ./outputs/innerpo-supr_math_seed1")
